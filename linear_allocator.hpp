...
public:
    ...
    linear_allocator(const linear_allocator& alloc) : 
            ...
            __data(__begin + std::distance(alloc.__begin, alloc.__data)),
    ...
    linear_allocator(linear_allocator && alloc) noexcept : 
        ...
        alloc.__begin = alloc.__curr = alloc.__last =
            alloc.__min_val_col_ptr = alloc.__min_val_row_ptr =  
                alloc.__row_name_ptr = alloc.__col_name_ptr = alloc.__data = alloc.__null_ptr = nullptr;
    }
    ...
    void bind_list_min_col(pointer ptr) noexcept {
        __min_val_col_ptr = ptr;
    }

    void bind_list_min_row(pointer ptr) noexcept {
        __min_val_row_ptr = ptr;
    }
   ...
   ~linear_allocator() {
    ...
    pointer get_element(size_t i) noexcept {
        return __data + i;
    } 

    const_pointer get_element(size_t i) const noexcept {
        return __data + i;
    }
    /*
    ...
    const_pointer null_ptr_data() const noexcept {
        return __null_ptr;
    }
